...
source("/project/spott/cshan/fiber-seq/code/clustering_methods/entropy/entropy_functions.r")

LEIDEN_DIR <- "/project/spott/cshan/fiber-seq/macrophage_project/clustering_methods/Leiden_Manhattan"
